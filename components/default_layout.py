...
nav_drop_down = dbc.DropdownMenu(
    [
        ...
        # dbc.DropdownMenuItem("Balances", active=True),
        # dbc.DropdownMenuItem("Prices"),
        # dbc.DropdownMenuItem("Transactions"),
        # dbc.DropdownMenuItem(divider=True),
        # dbc.DropdownMenuItem("Settings", header=True),
        # dbc.DropdownMenuItem("APIs"),
        # dbc.DropdownMenuItem("Portfolios - coming soon", disabled=True),
    ],
    label="Menu",
        ...
        html.Div(
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        dbc.NavbarBrand("Portfolio Tracker",
                            className="ml-2",
                            style = {'font-size': 30, 'padding-left':'3%'}
                        )
                    ),
                ],
                no_gutters = True
